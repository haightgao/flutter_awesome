...
class CellContentPage extends StatefulWidget {
  const CellContentPage({Key? key}) : super(key: key);

  @override
  State<CellContentPage> createState() => _CellContentPageState();
}

class _CellContentPageState extends State<CellContentPage> {
  @override
